...
export const stages: StageDef[] = [
  {
    ...
    entities: [
      ...
      // === 디플렉터 갭 스피너 (반전 방향) ===
      // D1 우측 갭 (x=17~23)
      { type: 'kinematic', position: { x: 20, y: 37 }, props: { density: 1, angularVelocity: -4, restitution: 0 }, shape: { type: 'box', width: 2.5, height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' } },
      // D2 좌측 갭 (x=3~9)
      { type: 'kinematic', position: { x: 6,  y: 46 }, props: { density: 1, angularVelocity:  4, restitution: 0 }, shape: { type: 'box', width: 2.5, height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' } },
      // D3 우측 갭 (x=17~23)
      ...
      { type: 'kinematic', position: { x: 6,  y: 68 }, props: { density: 1, angularVelocity: -4, restitution: 0 }, shape: { type: 'box', width: 2.5, height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' } },
      // === 퍼널 입구/내부 스피너 ===
      // 마블이 좌측(x=3~9)으로 몰려 퍼널 왼쪽 벽을 타고 내려오므로
      // 좌측 → 중앙으로 이어지는 경로에 배치
      { type: 'kinematic', position: { x: 7,  y: 96  }, props: { density: 1, angularVelocity:  4, restitution: 0 }, shape: { type: 'box', width: 2.5, height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' } },
      { type: 'kinematic', position: { x: 10, y: 101 }, props: { density: 1, angularVelocity: -4, restitution: 0 }, shape: { type: 'box', width: 2.5, height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' } },
      { type: 'kinematic', position: { x: 13, y: 105 }, props: { density: 1, angularVelocity:  4, restitution: 0 }, shape: { type: 'box', width: 2,   height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' } },
      // === 스피너 존 (y=77) ===
  ...
  },
  {
    ...
    entities: [
      ...
      // wheels
      {
        position: { x: 8, y: 75 },
        type: 'kinematic',
        shape: { type: 'box', width: 2, height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' },

...
export const stages: StageDef[] = [
  {
    ...
    entities: [
      ...
      // D2 좌측 갭 (x=3~9)
      { type: 'kinematic', position: { x: 6,  y: 49 }, props: { density: 1, angularVelocity:  4, restitution: 0 }, shape: { type: 'box', width: 2.5, height: 0.1, rotation: 0, color: '#ff6a00', bloomColor: '#ff6a00' } },
      // D3 우측 갭 (x=17~23)

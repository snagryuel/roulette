...
// 좌/우 벽 좌표 기반으로 구슬이 실제로 지나가는 영역만 포함
const ITEM_SPAWN_ZONES = [
  [11, 16, 29, 33],  // 채널 좌벽x=9.75 ~ 우벽x=17.5
  [10, 22, 60, 63],  // 채널 좌벽x=8.25 ~ 우벽x=24
  [10, 22, 72, 80],  // 채널 좌벽x=8.25 ~ 우벽x=24 (대각 장애물 아래)
  [10, 22, 83, 90],  // 채널 좌벽x=8.25 ~ 우벽x=24
  [10, 22, 92, 98],  // 채널 좌벽x=8.25 ~ 우벽x=24
];
const ITEM_COUNT = 5;

...
// Cascade Falls 맵 기준 아이템 스폰 존 [minX, maxX, minY, maxY]
// 제외 구간:
//   y=30~35: 디플렉터1 선 위 (아이템이 벽 위에 생길 수 있음)
//   y=37~42: 디플렉터2 선 위
//   y=49~54: 디플렉터3 선 위
//   y=56~61: 디플렉터4 선 위
//   y=75~79: 스피너 3개가 채널 대부분 덮음
const ITEM_SPAWN_ZONES = [
  [4,  21, 15, 22],  // 핀 Row A~C 사이 — 핀 사이로 마블 통과
  [18, 22, 36, 40],  // 디플렉터1 우측 갭 (x=17~23)
  [4,  8,  43, 47],  // 디플렉터2 좌측 갭 (x=3~9)
  [18, 22, 55, 59],  // 디플렉터3 우측 갭
  [4,  8,  62, 66],  // 디플렉터4 좌측 갭
  [4,  21, 79, 83],  // 스피너 아래 ~ 핀 Row D 위
  [4,  21, 86, 93],  // 핀 Row D~E 구간
];
const ITEM_COUNT = 10;

...
// 마블이 집중되는 갭/퍼널 입구에 배치
const ITEM_SPAWN_ZONES = [
  [18, 22, 38, 41],  // D1 우측 갭 — 마블이 D1 타고 내려와 집중
  [4,  8,  47, 51],  // D2 좌측 갭 — 마블이 D2 타고 집중
  [18, 22, 57, 60],  // D3 우측 갭 — 마블이 D3 타고 집중
  [4,  8,  63, 67],  // D4 좌측 갭 — 마블이 D4 타고 집중
  [10, 16, 80, 83],  // 메인 스피너 아래 — 마블이 중앙으로 모임
  [11, 15, 87, 90],  // 핀 Row D/E 중앙
  [11, 15, 93, 95],  // 퍼널 입구 직전 — 마블이 좁아지며 집중
];
const ITEM_COUNT = 10;
